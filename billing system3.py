...
def mainwindow():
    ...
    showallEntry=Button(window,text="Show Entries",width=15,height=2)
...
def updateitemwindow():
    ...
    storedTypeLabel.grid(row=2,column=3,pady=(10,0))
    storedTypeEntry=OptionMenu(window,storedTypeVar,*StoreOption)
    storedTypeEntry.grid(row=2,column=0,columnspan=5)

    addItemButton=Button(window,text="update item",width=20,height=2,command=lambda:addItem())
    addItemButton.grid(row=3,column=3,pady=(10,0))
